...
<div class="callout">
<p class="lead">Personne n'a tenu la combinaison <strong>marketplace + flotte + terrain</strong> à Abidjan. La fenêtre est ouverte maintenant.</p>
</div>
...
## Go-to-market — 5 mouvements

- **M0–6** : verrouiller Adjamé/Yopougon (20 Liaisons, 300 vendeurs, 350 commandes/jour).
- **M3–12** : prendre le VTC (**partenariat Yango**, flottes indépendantes, 3 cas clients -20 %).
- **M6–15** : devenir le **standard FNE-CI** (vente aux DAF : « récupérez votre TVA »).
- **M12–18** : étendre BTP / transport collectif / corporate.
- **M18–24** : sortir d'Abidjan (Bouaké, San Pedro) + pilote sous-régional.
...
| | An 1 | An 2 | An 3 |
|---|---|---|---|
| Commandes/jour (fin) | 600 | 1 500 | 2 800 |
| Véhicules abonnés (fin) | 1 500 | 4 000 | 8 000 |
| GMV | ~2,9 Mds F | ~11,5 Mds F | ~26 Mds F |
| **Revenu net** | **~0,28 Md F** | **~1,15 Md F** | **~3,2 Mds F** |
...
<div class="callout">
<p class="lead">Devenir <strong>le standard de fait</strong> de la pièce auto en Afrique de l'Ouest francophone.</p>
</div>

Abidjan d'abord. Puis la Côte d'Ivoire. Puis Dakar, Cotonou, et la sous-région — même modèle, même Mobile Money, même parc.

**Pièces — votre flotte, votre coût, votre contrôle.**

_Contact : fernando.kouame@gmail.com · pieces.ci · Confidentiel · Juin 2026._
