...
- [Manuel — Support & SAV](./manuel-support-sav-2026-08.md) — Mode d'emploi du module « Support & SAV » (espace Administration) : pilotage des litiges (prise en charge, résolution écrite, clôture) et des retours (chaîne Demandé → Inspecté → Remboursé), remboursement automatique du séquestre, notifications WhatsApp au client et horodatage de chaque étape — Août 2026 ([PDF](./manuel-support-sav-2026-08.pdf))
