...
- [Manuel d'utilisation vendeur](./deep-dive-manuel-vendeur.md) — Guide complet pour les vendeurs (onboarding KYC, garanties, catalogue IA, commandes, livraisons, paiement direct et versement immédiat, avis, zones de livraison) — Généré 2026-03-01
...
- [Manuel d'utilisation propriétaire](./deep-dive-manuel-proprietaire.md) — Guide complet pour les propriétaires de véhicules (lien de paiement, mobile money, paiement à la remise, suivi commande) — Généré 2026-03-01
...
- [Manuel d'utilisation client](./deep-dive-manuel-client.md) — Guide complet pour les acheteurs particuliers (recherche texte/photo IA/VIN, garage, commande directe, paiement en ligne ou à la remise, livraison, évaluations, litiges) — Généré 2026-03-01
...
- [Manuel technique paiement](./deep-dive-manuel-paiement-escrow.md) — Guide complet du système de paiement : modèle **paiement direct** (encaissement en ligne à la commande ou au livreur à la remise, aucun fonds bloqué, vendeur payé immédiatement), CinetPay, Orange/MTN/Wave, price snapshot, machine à états. Les sections escrow (HELD→RELEASED→REFUNDED, auto-libération 48 h) sont conservées et signalées « circuit en retrait » : elles décrivent le code actuel, pas le modèle annoncé — v2.0, août 2026
...
- [Email de partenariat — Sourcing international](./email-partenariat-sourcing-2026-09.md) — Modèle d'approche des fournisseurs de pièces à importer : email prêt à envoyer à Opisto, plus la grille d'adaptation par destinataire (Ovoko, Partsouq, Amayama, réseaux français) et les trois garde-fous de négociation — Septembre 2026
- [Note de cadrage — Sourcing international](./note-cadrage-sourcing-import-2026-09.md) ([PDF](./note-cadrage-sourcing-import-2026-09.pdf)) — Où sourcer les pièces de la rubrique « à importer » : les deux couches du parc ivoirien (européen par héritage, japonais par tendance), classement des gisements par intégrabilité réellement testée (Opisto 12 M pièces ouvert, eBay API officielle, Ovoko/Partsouq/Amayama bloqués), niveaux de prix relevés, et régime douanier réel par position tarifaire (10 % sur le gros du catalogue, ~12,5 % de charge non récupérable) — Septembre 2026
...
- [Bible du démarchage vendeurs](./guide-prospection-vendeurs-2026-08.md) — Trame d'entretien mot pour mot pour la prospection des grossistes de pièces détachées : cartographie des zones d'Abidjan, accroche verbatim, identification du décideur, 5 blocs de découverte, argumentaire à 4 accroches, 15 objections traitées en 5 familles, modèle économique et closing, fiche de compte-rendu — à utiliser avec le classeur `prospection/prospection-vendeurs-2026-08.xlsx` et le [manuel Liaison](./deep-dive-manuel-liaison.md) — Août 2026, trame revue septembre 2026 ([PDF](./guide-prospection-vendeurs-2026-08.pdf))
- [Manuel — CRM clients & vendeurs](./manuel-crm-clients-vendeurs-2026-08.md) — Mode d'emploi du CRM interne (espace Administration) : tableau de bord et tâches, fiches 360° avec timeline fusionnée, interactions, tags, segments clients/vendeurs, relances WhatsApp et rappel automatique du matin — Août 2026 ([PDF](./manuel-crm-clients-vendeurs-2026-08.pdf))
- [Manuel — ERP Stock, achats & fournisseurs](./manuel-erp-stock-achats-2026-08.md) — Mode d'emploi du module « Stock & achats » (espace Administration) : cockpit inventaire 8 compteurs, niveaux et ajustements, journal des mouvements, bons de commande avec coût rendu entrepôt (fret + douane + last-mile), réception partielle, fiches fournisseurs, automatismes de stock et pastilles de stock catalogue — Août 2026 ([PDF](./manuel-erp-stock-achats-2026-08.pdf))
- [Manuel — ERP Finance](./manuel-erp-finance-2026-08.md) — Mode d'emploi du module « Finance » (espace Administration) : cockpit comptable en lecture seule (GMV, commissions, reliquats de séquestre bloqué/libéré — un mécanisme en retrait qui doit tendre vers zéro sous le paiement direct), ventilation des 12 derniers mois avec variations, agrégation par vendeur et exports CSV mensuels prêts pour Excel (commandes, commissions, mouvements escrow) — Août 2026 ([PDF](./manuel-erp-finance-2026-08.pdf))
- [Manuel — Marketing](./manuel-marketing-campagnes-2026-08.md) — Mode d'emploi du module « Marketing » (espace Administration) : campagnes WhatsApp en masse ciblées via segments CRM et tags, aperçu d'audience, envoi immédiat ou planifié, exclusion automatique des désabonnés, traçage des envois dans les fiches CRM et suivi des compteurs — Août 2026 ([PDF](./manuel-marketing-campagnes-2026-08.pdf))
- [Manuel — Support & SAV](./manuel-support-sav-2026-08.md) — Mode d'emploi du module « Support & SAV » (espace Administration) : pilotage des litiges (prise en charge, résolution écrite, clôture) et des retours (chaîne Demandé → Inspecté → Remboursé), remboursement (automatique sur les reliquats de séquestre, sinon réglé avec le vendeur), notifications WhatsApp au client et horodatage de chaque étape — Août 2026 ([PDF](./manuel-support-sav-2026-08.pdf))
- [Manuel — Sourcing & Expéditions](./manuel-sourcing-expeditions-2026-08.md) — Mode d'emploi des modules « Sourcing » et « Expéditions » (espace Administration) : saisie manuelle des offres relevées sur les sites de vente (le mode standard), matrice d'arbitrage au coût rendu Abidjan (immobilisation comprise), confirmation des prix, génération du bon de commande, suivi d'expédition étape par étape, page de suivi client — et recherche automatique par assistant en complément — Août 2026 ([PDF](./manuel-sourcing-expeditions-2026-08.pdf))
- [Manuel — Console ERP & CRM (erp.pieces.ci)](./manuel-erp-crm-console-2026-08.md) — Manuel chapeau de la console d'administration séparée : règle de routage du sous-domaine, fiches équipe et 7 rôles métier, matrice des 17 capacités, carte complète des écrans (en production sous /admin / à construire / phases 2-3), cockpit consolidé des 3 lignes d'activité, tâches et notes internes, numérotation atomique, référentiels (pièces, fiches terrain, imports externes, clients, vendeurs, entreprises, liaisons, équipe & commissions, modélisation), gouvernance, feuille de route et limites connues — Août 2026 ([PDF](./manuel-erp-crm-console-2026-08.pdf))
- [Proposition — Réorganisation de l'administration](./proposition-reorganisation-admin-2026-08.md) — Diagnostic de la console actuelle (19 entrées à plat, 4 annuaires redondants, pas d'écran Commandes, navigation muette) et proposition de refonte : 9 sections par processus, file de travail unique « Ma journée », fiche de compte unifiée à facettes, recherche globale, badges de navigation, renommages, table de correspondance des 19 entrées, matrice de visibilité par métier, schéma d'URL et plan de bascule en 4 lots — Août 2026 ([PDF](./proposition-reorganisation-admin-2026-08.pdf))
- [Référentiel logistique — Familles de pièces](./logistique-familles-pieces-2026-07.md) — Récapitulatif des 17 groupes de pièces détachées de logistique.pieces.ci : fourchettes poids/volume, poids taxable aérien & LCL, poste dominant, restrictions aériennes et fragilité, niveaux de confiance d'estimation — Juillet 2026 ([PDF](./logistique-familles-pieces-2026-07.pdf))
