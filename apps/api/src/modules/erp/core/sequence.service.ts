...
//
// Le problème corrigé : l'ancienne numérotation des factures faisait
...
// des deux plantait, et la facture n'était jamais émise.
//
 ...
 *
 * Le numéro est consommé dès l'appel : si la transaction appelante échoue
...
/** Lecture seule, pour l'écran Paramètres › Séquences. */
