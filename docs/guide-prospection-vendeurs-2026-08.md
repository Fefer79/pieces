...
En prélancement, deux interdits s'ajoutent : **aucune promesse de ventes ou de volume à l'ouverture** — la primauté est une position, pas un chiffre d'affaires annoncé — et **aucune date de lancement au jour près**. On dit « dans les trente jours », rien de plus précis.
