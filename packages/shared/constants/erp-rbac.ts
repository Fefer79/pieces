 ...
 * (`ACHETEUR` a `purchase:order` mais pas `purchase:approve`), et la clôture
 * comptable échappe à tout le monde sauf la direction et le comptable.
 */
export const ERP_CAPABILITIES: Record<StaffRoleKey, readonly ErpCapability[]> = {
  ...
  ACHETEUR: ['erp:read', 'crm:read', 'purchase:read', 'purchase:order', 'stock:read'],
