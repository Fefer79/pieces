...
- [Bible du démarchage vendeurs](./guide-prospection-vendeurs-2026-08.md) — Guide d'entretien pour la prospection des grossistes de pièces détachées : cartographie des zones d'Abidjan, 25 questions de qualification du stock, argumentaire, 12 objections traitées, modèle économique et closing, fiche de compte-rendu — à utiliser avec le classeur `prospection/prospection-vendeurs-2026-08.xlsx` — Août 2026 ([PDF](./guide-prospection-vendeurs-2026-08.pdf))
