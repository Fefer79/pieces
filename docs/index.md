...
- [Manuel — Sourcing & Expéditions](./manuel-sourcing-expeditions-2026-08.md) — Mode d'emploi des modules « Sourcing » et « Expéditions » (espace Administration) : recherche automatique d'offres sur les sites de vente internationaux depuis une demande de cotation, matrice d'arbitrage au coût rendu Abidjan (immobilisation comprise), confirmation des prix, génération du bon de commande, suivi d'expédition étape par étape et page de suivi client — Août 2026 ([PDF](./manuel-sourcing-expeditions-2026-08.pdf))
